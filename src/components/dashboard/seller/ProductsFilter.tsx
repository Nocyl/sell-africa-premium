      ...
      <div className="flex gap-2">
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-56">
            ...
            <DropdownMenuSeparator />
            <DropdownMenuRadioGroup value={productType} onValueChange={handleTypeChange}>
              <DropdownMenuRadioItem value="all">Tous les produits</DropdownMenuRadioItem>
              <DropdownMenuRadioItem value="digital">Produits digitaux</DropdownMenuRadioItem>
              <DropdownMenuRadioItem value="physical">Produits physiques</DropdownMenuRadioItem>
            </DropdownMenuRadioGroup>
            
            <DropdownMenuLabel className="mt-2">Statut</DropdownMenuLabel>
            <DropdownMenuSeparator />
            <DropdownMenuRadioGroup value={status} onValueChange={handleStatusChange}>
              ...
              <DropdownMenuRadioItem value="in_stock">En stock</DropdownMenuRadioItem>
              <DropdownMenuRadioItem value="low_stock">Stock faible</DropdownMenuRadioItem>
              <DropdownMenuRadioItem value="out_of_stock">Épuisé</DropdownMenuRadioItem>
            </DropdownMenuRadioGroup>
            ...
            <DropdownMenuRadioGroup value={sort} onValueChange={handleSortChange}>
              ...
              <DropdownMenuRadioItem value="sales">Meilleures ventes</DropdownMenuRadioItem>
            </DropdownMenuRadioGroup>
          </DropdownMenuContent>
        </DropdownMenu>
      </div>
